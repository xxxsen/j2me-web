...
MINIJVM_COMMIT="${MINIJVM_COMMIT:-1778bd07fea64213d5e4d3061a489044abf458e7}"
FREEJ2ME_REPOSITORY="${FREEJ2ME_REPOSITORY:-https://github.com/xxxsen/freej2meOnMinijvm.git}"
FREEJ2ME_COMMIT="${FREEJ2ME_COMMIT:-e90225a2f992bec746435293fd2b9c401df9f5cc}"
FREEJ2ME_PLUS_REPOSITORY="${FREEJ2ME_PLUS_REPOSITORY:-https://github.com/xxxsen/freej2me-plus.git}"
FREEJ2ME_PLUS_COMMIT="${FREEJ2ME_PLUS_COMMIT:-bc6fc7cd03d8d7eeae40bceb86d7424efbacbc18}"
