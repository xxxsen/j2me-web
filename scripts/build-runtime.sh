...
FREEJ2ME_COMMIT="${FREEJ2ME_COMMIT:-a9d5e8b1296088ba44d94dd71571cac5751947ea}"
FREEJ2ME_PLUS_REPOSITORY="${FREEJ2ME_PLUS_REPOSITORY:-https://github.com/xxxsen/freej2me-plus.git}"
FREEJ2ME_PLUS_COMMIT="${FREEJ2ME_PLUS_COMMIT:-6e48b3ff3544b143890e9132efeb4a64b63412cf}"
