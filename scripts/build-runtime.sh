...
FREEJ2ME_COMMIT="${FREEJ2ME_COMMIT:-beda00ab807b3c25d6099a0942a59e6c1580c5a6}"
FREEJ2ME_PLUS_REPOSITORY="${FREEJ2ME_PLUS_REPOSITORY:-https://github.com/xxxsen/freej2me-plus.git}"
FREEJ2ME_PLUS_COMMIT="${FREEJ2ME_PLUS_COMMIT:-3f8e2742acebe69eecbb99320e09e4128ff41628}"
